                ...
                <div class="row ">
                    <div class="col-lg-6 col-12">
                        <div class="table-pg">
                            ...
                            <p><a href="{{ route('checkout', 'gila-belajar') }}" class="btn btn-primary w-100">Take This Plan</a></p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="table-bm">
                            ...
                            <p><a href="{{ route('checkout', 'baru-mulai') }}" class="btn btn-secondary w-100">Take This Plan</a></p>
                        </div>
                    </div>
                </div>
